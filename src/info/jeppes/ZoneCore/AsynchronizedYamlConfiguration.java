...
public abstract class AsynchronizedYamlConfiguration extends YamlConfiguration implements AsynchronizedStorageHolder{
    @Override
    public void schedualSave(){
        AsynchroizedStorageManager.schedualSave(this);
    }
    @Override
